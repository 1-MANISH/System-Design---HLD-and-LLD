...
4. we have getter and setter to access and set this private data members.
*/
...
public:
    SportsCar(string b, string m) {
        ...
        this->currentSpeed = 0;
        this->currentGear = 0;
        this->tyreCompany = "MRF";// Default tyre company
    }
...
int main() {
    ...
    SportsCar* mySportsCar = new SportsCar("Porsche","911 Turbo");
